...
public class StringUtils {
    ...
    public static boolean isAllEmpty(String str) {
        return "null".equalsIgnoreCase(str) || "undefined".equalsIgnoreCase(str) || isNullEmpty(str);
    }
     ...
     */
    public static boolean isLimit(String data, int minLen, int maxLen) {
        if (isNullEmpty(data)) {
            return minLen < 1;
        }
    ...
    public static String convertObjectToString(Object obj, String resultStr) {
        return (null == obj || "".equals(obj.toString()) || "null".equals(obj.toString())) ? resultStr : obj.toString();
    }
    ...
    public static String convertObjectToString(Object obj) {
        return convertObjectToString(obj, LINE);
    }
